...
import "./chunk-RA4TXY3N.js";
import {
  useThemeProps
} from "./chunk-UQQTJ2JO.js";
import {
  getPanelId,
  getTabId,
  useTabContext
} from "./chunk-4Q23SL6C.js";
import "./chunk-FMFFUJ5P.js";
import "./chunk-YBUO2JNX.js";
import "./chunk-IVXJEAJZ.js";
import {
  require_react_dom
...
var Portal = React27.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React27.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
function useSlider(parameters) {
  ...
  const touchId = React52.useRef(void 0);
  ...
  const sliderRef = React52.useRef(null);
  ...
  const previousIndex = React52.useRef(void 0);
    ...
    children: [(0, import_jsx_runtime30.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime30.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime31.jsxs)(Thumb, _extends({
        ...
        children: [(0, import_jsx_runtime30.jsx)(Input3, _extends({
          ...
          value: values[index2]
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime30.jsx)(ValueLabel, _extends({}, !isHostComponent_default(ValueLabel) && {
          valueLabelFormat,
          index: index2,
          disabled
        }, valueLabelProps, {
...
var TabPanel = React65.forwardRef(function TabPanel2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime41.jsx)(TabPanelRoot2, _extends({}, tabPanelRootProps, {
...
var TextareaAutosize = React71.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const heightRef = React71.useRef(null);
...
var _excluded28 = ["children", "className", "value"];
...
var TabPanel3 = React75.forwardRef(function TabPanel4(inProps, ref) {
  ...
  return (0, import_jsx_runtime49.jsx)(TabPanelRoot, _extends({
